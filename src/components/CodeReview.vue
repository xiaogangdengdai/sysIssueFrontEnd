  ...
  <div class="page-container">
    <el-card>
      <template #header>
        <div class="card-header">
          ...
          <span class="title">📝 代码Review报告</span>
      ...
      <el-table :data="tableData" v-loading="loading" border stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="description" label="Review要求描述" min-width="300" show-overflow-tooltip />
    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="900px">
      <el-form ref="formRef" :model="formData" :rules="formRules" label-width="130px">
        <el-form-item label="Code Review要求" prop="description">
          <el-input v-model="formData.description" type="textarea" :rows="6" placeholder="请输入代码Review要求描述，例如：请检查用户登录模块的安全性和性能" />
        </el-form-item>
    ...
    <el-dialog v-model="viewDialogVisible" title="查看详情" width="900px">
      <el-descriptions :column="1" border>
        <el-descriptions-item label="Code Review要求">
...
const formRules: FormRules = {
  description: [{ required: true, message: '请输入Code Review要求描述', trigger: 'blur' }],
...
const handleAdd = () => {
  dialogTitle.value = '新增Code Review'
...
const handleEdit = async (row: SystemIssueLog) => {
  dialogTitle.value = '编辑Code Review'
